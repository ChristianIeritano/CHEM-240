...
'''
Written by CI for CHEM 240 offered Fall 2024
Code adapted from the following courses. Please cite usage accordingly should you use this code in your teachings. 

https://github.com/Xiu-Wawa/Physics-Simulation
https://github.com/benmoseley/harmonic-oscillator-pinn-workshop/tree/main
'''
